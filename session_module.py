...
class flow_login_session:
    def __init__(self, username, password, typechat):
    ...
    def instance_session(self, initial_msg):
        # Crear un nuevo hilo
    ...
    def try_login_session(self, initial_msg):
        
        instance_created = self.instance_session(initial_msg)
